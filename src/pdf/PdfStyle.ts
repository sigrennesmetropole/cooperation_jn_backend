...
export function getPdfStyle() {
  ...
  return `
        ...
        @font-face {
            ...
            font-weight: 400;
            font-display: swap;
            src: url('data:application/font-woff2;charset=utf-8;base64,${fontData1}') format('woff2');
        ...
        @font-face {
            ...
            font-weight: 400;
            font-display: swap;
            src: url('data:application/font-woff2;charset=utf-8;base64,${fontData2}') format('woff2');
